...
class Funciones_Globales():
    ...
    def validar_elemento_localizado(self,tipo,selector):
    ...
    def validar_elemento_visible(self,tipo,selector,tiempo=.2):
        ...
        try:
            val = Funciones_Globales.validar_elemento_localizado(self,tipo,selector)
    ...
    def DragDrop_AC(self,tipo,selectordrag,selectordrop,tiempo=.2):
        tipo = Funciones_Globales.definir_tipo(tipo)
        try:
            val = Funciones_Globales.validar_elemento_localizado(self,tipo,selectordrag)
            val2 = Funciones_Globales.validar_elemento_localizado(self,tipo,selectordrop)
            act = AC(self.driver)
    ...
    def copiar_pegar(self,tipo,copy,paste,tiempo=.2):
        tipo = Funciones_Globales.definir_tipo(tipo)
        try:
            val = Funciones_Globales.validar_elemento_localizado(self,tipo,copy)
            act = AC(self.driver)
            ...
            val = Funciones_Globales.validar_elemento_localizado(self,tipo,paste)
